...
class NWordCounter(commands.Cog):
    ...
    @commands.slash_command(name="count", description="Get a person's total n-word count")
    ...
    @commands.slash_command(name="vote", description="Vouch to verify someone's blackness")
    ...
    @commands.slash_command(name="whoblack", description="See who's verified black in this server")
    ...
    @commands.slash_command(name="whohaspass", aliases=["whopass"], description="See who has an n-word pass in this "
                                                                                "server")
    ...
    @commands.slash_command(name="passes", description="See your or someone else's total passes available")
    ...
    @commands.slash_command(name="givepass", description="Give n-word pass to another user")
